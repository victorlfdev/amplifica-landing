    ...
    >
      <Reveal>
        <div className="rounded-[1.9rem] border border-[var(--accent)]/20 bg-[linear-gradient(180deg,rgba(213,185,138,0.14),rgba(255,255,255,0.04))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.34)] sm:rounded-[2.2rem] sm:p-8 lg:p-12">
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-12 lg:flex-row lg:items-center">
            ...
            <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4 lg:items-center lg:text-center">
              <a
