...
export function FinalCtaSection() {
  return (
    ...
    >
      <Reveal>
        <div className="rounded-[2.2rem] border border-[var(--accent)]/20 bg-[linear-gradient(180deg,rgba(213,185,138,0.14),rgba(255,255,255,0.04))] p-8 shadow-[0_24px_80px_rgba(0,0,0,0.34)] sm:p-10 lg:p-12">
